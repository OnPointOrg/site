               ...
               <Box pb="120px">
                  ...
                  >
                     ...
                     <Feature icon={<FaSearch />} title="Analytic Articles">
                        ...
                        topics such as how sport drafts work or how the
                        electoral college functions.
                     </Feature>
                     <Feature icon={<FaPlay />} title="Weekly Videos">
                        Weekly videos provide a brief description of the events
               ...
               <Box py="120px" px="32px" color="white">
                  <Box mx="auto" textAlign="center" mb="56px" width="75%">
                     ...
                     <Text fontSize="lg" opacity={0.7}>
                        To keep your experience a satisfying and memorable one,
                        we will graciously accept donations to fund our
               ...
               >
                  <Flex direction="column" align="center" mx="auto">
                     ...
                     <Text mb="40px" fontSize="lg" opacity={0.7}>
                        Make your free account to start writing the next big
                        story! If you have any other questions, contact us by{' '}
                        <ChakraLink
