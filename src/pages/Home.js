                    ...
                    <Box pb="120px">
                        ...
                        >
                            ...
                            <Text opacity={0.7} fontSize="lg">
                                Well Maybe Not Redefine, But You'll Still Make
                                An Impact
                            </Text>
                        </Box>
                        <Grid
                        ...
                        >
                            ...
                            >
                                Articles about relevant topics that are concise
                                yet detailed and include visual aids. Crafted to
                            ...
                            >
                                Long articles containing deep analysis about
                                certain topics such as how sport drafts work or
                                how the electoral college functions.
                            </Feature>
                            <Feature icon={<FaPlay />} title="Weekly Videos">
                                Weekly videos provide a brief description of the
                                events we covered during the week.
                            </Feature>
                    ...
                    <Box py="120px" px="32px" color="white">
                        <Box mx="auto" textAlign="center" mb="56px" width="75%">
                            ...
                            <Text fontSize="lg" opacity={0.7}>
                                To keep your experience a satisfying and
                                memorable one, we will graciously accept
                                donations to fund our operations to continue
                            </Text>
                        </Box>
                    ...
                    >
                        <Flex direction="column" align="center" mx="auto">
                            ...
                            <Text mb="40px" fontSize="lg" opacity={0.7}>
                                Make your free account to start writing the next
                                big story! If you have any other questions,
                                contact us by{' '}
                                <ChakraLink
